...
3. **Carte P0** : `region_layout.json` fournit les coordonnées approximatives normalisées `0..1`. `region_layout.csv` est un miroir éditable. La carte SVG/polygonale ne bloque pas le P0.
